...
```
رفع خطای awk در آمار ترافیک و گزینه‌های ازدست‌رفته منوی خروجی SOCKS5
حذف ارائه‌دهنده DNS نام‌دامنه namedotcom (از hysteria v2.11.0 پشتیبانی نمی‌شود)
رفع عدم نمایش ردیف‌های آمار ترافیک و بازطراحی جدول اتصالات فعال
```
